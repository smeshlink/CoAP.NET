...
namespace System.Collections.Concurrent
{
    ...
    internal class ConcurrentDictionary<TKey, TValue> : IDictionary<TKey, TValue>, IDictionary
    {
        ...
        internal ConcurrentDictionary(int concurrencyLevel, int capacity, bool growLockArray, IEqualityComparer<TKey> comparer)
        {
            ...
            {
                throw new ArgumentOutOfRangeException("concurrencyLevel", "ConcurrencyLevelMustBePositive");
            }
            if (capacity < 0)
            {
                throw new ArgumentOutOfRangeException("capacity", "CapacityMustNotBeNegative");
            }
            if (comparer == null) throw new ArgumentNullException("comparer");
        ...
        void ICollection<KeyValuePair<TKey, TValue>>.CopyTo(KeyValuePair<TKey, TValue>[] array, int index)
        {
            ...
            if (index < 0) throw new ArgumentOutOfRangeException("index", "IndexIsNegative");
        ...
        {
            if (keyValuePair.Key == null) throw new ArgumentNullException("ItemKeyIsNull");
        ...
        {
            if (key == null) throw new ArgumentNullException("key");
            if (!(key is TKey)) throw new ArgumentException("TypeOfKeyIncorrect");
            ...
            {
                throw new ArgumentException("TypeOfValueIncorrect");
            }
        ...
        object IDictionary.this[object key]
        {
            ...
            set
            {
                ...
                if (!(key is TKey)) throw new ArgumentException("TypeOfKeyIncorrect");
                if (!(value is TValue)) throw new ArgumentException("TypeOfValueIncorrect");
        ...
        void ICollection.CopyTo(Array array, int index)
        {
            ...
            try
            {
                ...
                throw new ArgumentException("ArrayIncorrectType", "array");
            }
            finally
            {
                ReleaseLocks(0, locksAcquired);
        ...
        object ICollection.SyncRoot
        {
            get
            {
                throw new NotSupportedException("SyncRoot_NotSupported");
            }
        }
